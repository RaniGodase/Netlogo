...
[
  ...
  gamma                 ;; The average number of new vaccinated
                        ;; per non-infected  this tick
...
[
  ...
  vaccinated?         ;; If true, the person has already vaccinated.
  ...
  vaccination-time    ;; Time (in hours) it takes to vaccinate person
  nb-infected         ;; Number of secondary infections caused by an
                      ;; infected person at the end of the tick
  nb-non-infected     ;; Number of non-infected  people due to vaccination
]
...
to setup-people
  ...
  [
    ...
    set vaccination-time random-normal average-vaccination-time average-vaccination-time / 4

    ;; make sure it lies between 0 and 2x average-recovery-time
    if vaccination-time > average-vaccination-time * 2 [
      set vaccination-time average-vaccination-time * 2
    ]
    if vaccination-time < 0 [ set vaccination-time 0 ]
    ...
    [
      ...
      set infection-length random vaccination-time
    ]
    assign-color
  ]
end
...
;; blue is neither infected nor cured (set at beginning)
;; yellow is a vaccinated person
...
to infect  ;; turtle procedure
  ...
  [ ask nearby-uninfected
    [ if random-float 100 < infection-chance
      ...
      if random-float 100 < vaccination
        [ set vaccinated? true
          set nb-non-infected (nb-non-infected + 1)
        ]
      ]
    ]
end
...
1214
421
cumulative Infected and vaccinated
hours
% of Population
0.0
10.0
...
"" ""
PENS
"vaccinated" 1.0 0 -1184463 true "" "plot ((count turtles with [vaccinated?] / initial-people ))"
"infected" 1.0 0 -2674135 true "" "plot((( count turtles with [ vaccinated? ] + count turtles with [ infected? ]) / initial-people) * 100)"
...
"vaccinated" 1.0 0 -1184463 true "" "plot count turtles with [ not infected? ]"
